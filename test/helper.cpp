...
std::string buildRelease(std::string defines_) {
	...
	return std::string("cl /permissive- /GS /GL /W3 /Gy /Zc:wchar_t /Gm- /O2 /sdl /Zc:inline /fp:precise /DNDEBUG /D_CONSOLE /D_UNICODE /DUNICODE /errorReport:prompt /WX- /Zc:forScope /GR- /Gd /Oi /MT /EHsc /nologo /diagnostics:classic /std:c++latest /MP1 /cgthreads1") + defines + " ..\\official.cpp";
		//string is copy-pasted from Rel-NoPDB config
}
std::string buildDebug(std::string defines_) {
	std::string defines = replace_string(defines_, " -D", " /D");
	return std::string("cl /permissive- /GS /W3 /Zc:wchar_t /ZI /Gm /Od /sdl /Zc:inline /fp:precise /D_DEBUG /D_CONSOLE /D_UNICODE /DUNICODE /errorReport:prompt /WX- /Zc:forScope /RTC1 /Gd /MDd /EHsc /nologo /diagnostics:classic /std:c++latest /MP1 /cgthreads1") + defines + " ..\\official.cpp";
